...
Gem::Specification.new do |s|
  ...
  s.description = "With minimal set up RailsSync presents limited rails model interfaces within the JS font end. Records accessed are kept updated through action cable."
  s.license     = "MIT"
