...
export default class Model {
  ...
  static create(data){
    return Axios.post( `${this.url_path_base}${SnakeCase(this.className)}`, Util.snakeCaseKeys(data))
        .then((response) => {
  ...
  static update(data){
    return Axios.put( `${this.url_path_base}${SnakeCase(this.className)}/${data.id}`, Util.snakeCaseKeys(data))
        .then((response) => {
          new this(response.data)
          return response
        })
  ...
  static loadRecords(args = undefined){
    ...
    const PathBase = `${this.url_path_base}${SnakeCase(this.className)}`
    switch(typeof args){
      case 'undefined':
